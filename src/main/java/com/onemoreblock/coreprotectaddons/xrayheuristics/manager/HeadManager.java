...
import com.onemoreblock.coreprotectaddons.xrayheuristics.callback.HandledPlayerHeadCallback;
...
public class HeadManager {
     ...
     */
    public static @NonNull ItemStack GetPlayerHead(UUID playerUUID, HandledPlayerHeadCallback callback) {
